...
if (isset($_POST['add_new_cc'])) {
  ...
  if ($count > 0) {
    $errors[] = $name.' customer is already exits in your database!';
  }
...
<section id="add_new_credit_cus">
  <div class="container">
    <h3 class="text-center text-info">ADD NEW CUSTOMER</h3><hr>
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        ...
        <form action="add_new_credit_cus.php" method="POSt" id="add_new_CC">
          <button type="submit" name="add_new_cc" class="btn btn-lg btn-warning" style="float:right;width:150px;letter-spacing:2px;">Submit <i class="fas fa-location-arrow"></i></button>
          <a href="credit_cus.php" class="btn btn-lg btn-info" style="float:right;width:150px;letter-spacing:2px;margin-right:4px;"><i class="fas fa-chevron-circle-left"></i> Back</a>
        </form>
      </div>
    </div>
  </div>
